...
exports.updateTopicQuery = (eventId, topicId) =>
  connection.query(
    "UPDATE event_topic SET topic_id = $1 WHERE event_id = $2;",
    [topicId, eventId]
  );
...
exports.updateSecondaryTagQuery = (publicServiceId, secondaryTag) =>
  connection.query(
