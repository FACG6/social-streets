BEGIN;
  ...
  INSERT INTO "user"
    (first_name, last_name, email, password, avatar, business_type, website, organisation_name, address, city, country, zip_code, facebook, instagram, twitter)
  VALUES
    ('Ahmed', 'Abdellatif', 'ahmedisam9922@gmail.com', '$2y$12$0tqIpfxzTSFIKFECzjS1XOKhhxAlPsexglTCOKhysSXVt.R4KTBAW', NULL, 'Charity', 'https://www.google.com', 'Ahmed Co.', 'Omar Al-Mukhtar St.', 'Gaza', 'Palestine', '79702', 'https://www.facebook.com', 'https://www.instagram.com', 'https://www.twitter.com'),
