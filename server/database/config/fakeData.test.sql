BEGIN;
    ...
    INSERT INTO public_service (primary_tag, description, image, focus_key, alt_text, meta, publisher_id, publish_datetime, title, is_draft)
        VALUES (2, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', '1_profile-pic.jpg', 'Lorem', 'ALT TEXT', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 1, '11/6/ 2019 - 04.30 p.m', 'News Title', false);
    ...
    INSERT INTO event (title, description, category, event_datetime, venue, website, cost, image, focus_key, meta, alt_text, is_draft, publisher_id, publish_datetime)
        VALUES 
        ('The main Event', ' Lorem Ipsum has been the industrys standard dummy text ever since the 1500s,', 1, '11/6/ 2019 - 04.30 p.m', 'Abed al Aziz Venue',  'www.gaza-sky-geeks.com', '15', '2_profile-pic.jpg', 'Lorem', 'Lorem  Ipsum is simply dummy text of the printing  and typesetting industry.', 'alt text', false, 1, '11/4/2019 - 02.23 p.m'),
        ('The main Event', ' Lorem Ipsum has been the industrys standard dummy text ever since the 1500s,', 1, '11/6/ 2019 - 04.30 p.m', 'Abed al Aziz Venue',  'www.gaza-sky-geeks.com', '15', '3_profile-pic.jpg', 'Lorem', 'Lorem  Ipsum is simply dummy text of the printing  and typesetting industry.', 'alt text', false, 1, '11/4/2019 - 02.23 p.m');
