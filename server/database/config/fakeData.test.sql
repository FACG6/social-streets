BEGIN;
    ...
    INSERT INTO public_services (primary_tag, description, image, focus_key, alt_text, meta, publisher_id, publish_datetime, title, is_draft)
    ...
    INSERT INTO public_services_tag (secondary_tag, public_services_id)
        VALUES (1, 1), 
               (2, 1), 
               (3, 1); 
