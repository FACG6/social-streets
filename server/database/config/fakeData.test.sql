BEGIN;
    ...
    INSERT INTO user (first_name, last_name, email UNIQUE, password, avatar, business_type, website, organisation_name, address, city, country, postal_code, facebook, instagram, twitter)
    ...
    INSERT INTO news_tag (secondary_tag, news_id)
        VALUES (1, 1), (2, 1), (3, 1); 
